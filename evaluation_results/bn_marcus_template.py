...
# print(cvs_file)
csv_file = pd.read_csv("/home/dhruv/Desktop/bn-validation-platform/llm_created_bn/Converted N Stage Model/Marcus/evaluation.csv",header=0)
...
title = """
# Causal Reasoning of edges of BN constructed by Marcus.
